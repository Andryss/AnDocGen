...
Документ описывает модульную архитектуру AnDocGen: состав системы, потоки данных между модулями и взаимодействие с пользователем. Описание не привязано к конкретному языку программирования или технологическому стеку.
